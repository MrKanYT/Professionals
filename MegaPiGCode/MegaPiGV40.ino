...
int _gtv44 = 0; //Ошибка для движения между препятствиями
int _gtv45 = 130;
...
String _GSFS6 = "0";
bool _FSFS14CO = 0;
long _convertStringToNamberOutput_7 = 0L;
bool _trgrt8 = 0;
bool _trgrt8I = 0;
bool _FSFS4CO = 0;
bool _tim7I = 0;
...
//Комментарии:Производится если осуществляетсяя движение вперед F и расстояние в диапазоне 50-320 мм до стены Расстояния считываются 1 раз в 50 м Ошибка от заданного значения от стены 190 мм Kp=1 Kd=1 Ki=0
    En = (((_gtv15) > (50)) && (_gtv39) && ((_gtv15) < (320)) && (_gtv19));
    myErr = (_gtv15)-(200);
    kP = 1;
    kD = 1;
    kI = 0;
...
//Наименование:Прием из Bluetooth
     ...
     else 
    {
         ...
         else 
        {
             if (_tim7O) 
            {
                if (_isTimer(_tim7P, 10)) _tim7O = 0;
            }
        }
    }
    in_172724170_1 = _tim7O;
    out_172724170_1=0;
...
//Наименование:Расшифровка принятого из порта
    if (_gtv10 == 1) 
    {
        _FSFS12CO = ((_gtv9).indexOf(String("F")))>-1;
        _gtv3 = _FSFS12CO;
        ...
        if (_FSFS12CO) 
        {
            _gtv11 = (constrain((_convertStringToNamberOutput_11), (-2500), (2500)));
        }
        _FSFS13CO = ((_gtv9).indexOf(String("R")))>-1;
        _gtv16 = _FSFS13CO;
        ...
        if (_FSFS13CO) 
        {
            _gtv14 = (constrain((_convertStringToNamberOutput_17), (-600), (600)));
        }
        _FSFS14CO = ((_gtv9).indexOf(String("N")))>-1;
        _gtv21 = _FSFS14CO;
        _FSFS10CO = ((_gtv9).indexOf(String("S")))>-1;
        _GSFS13 = (_gtv9).substring((1));
        _tempVariable_String = _GSFS13;
        _convertStringToNamberOutput_20 = strtol(_tempVariable_String.c_str(),NULL,10);
        if (_FSFS10CO) 
        {
            _gtv22 = (constrain((_convertStringToNamberOutput_20), (5), (130)));
        }
        ...
        _FSFS6CO = ((_gtv9).indexOf(String("H")))>-1;
        if (_FSFS6CO) 
        {
            _gtv24 = (constrain((_convertStringToNamberOutput_13), (0), (2)));
        }
        ...
        _FSFS5CO = ((_gtv9).indexOf(String("G")))>-1;
        if (_FSFS5CO) 
        {
            _gtv27 = ((constrain((_convertStringToNamberOutput_9), (0), (1)))) == (1);
        }
        ...
        _FSFS1CO = ((_gtv9).indexOf(String("L")))>-1;
        if (_FSFS1CO) 
        {
            _gtv29 = ((constrain((_convertStringToNamberOutput_8), (0), (1)))) == (1);
        }
        ...
        _FSFS2CO = ((_gtv9).indexOf(String("Q")))>-1;
        if (_FSFS2CO) 
        {
            _gtv30 = (constrain((_convertStringToNamberOutput_7), (10), (120000L)));
        }
        ...
        _FSFS3CO = ((_gtv9).indexOf(String("X")))>-1;
        _gtv31 = _FSFS3CO;
        if (_FSFS3CO) 
        {
            _gtv33 = ((constrain((_convertStringToNamberOutput_1), (0), (1)))) == (1);
        }
        ...
        _FSFS4CO = ((_gtv9).indexOf(String("W")))>-1;
        _gtv35 = _FSFS4CO;
        if (_FSFS4CO) 
        {
            _gtv36 = (constrain((_convertStringToNamberOutput_5), (200), (1000)));
        }
        _FSFS7CO = ((_gtv9).indexOf(String("Y")))>-1;
        ...
        if (_FSFS7CO) 
        {
            _gtv37 = (constrain((_convertStringToNamberOutput_10), (5), (130)));
        }
        _FSFS8CO = ((_gtv9).indexOf(String("V")))>-1;
        _gtv42 = _FSFS8CO;
        ...
        if (_FSFS8CO) 
        {
            _gtv41 = (constrain((_convertStringToNamberOutput_14), (-15), (15)));
        }
        _FSFS9CO = ((_gtv9).indexOf(String("J")))>-1;
        _gtv43 = _FSFS9CO;
    }
    //Плата:6
...
//Комментарии:Ограничение времени поиска линии
    if(((!(_gtv3)) && (_gtv10) && (!(_gtv42)))) _trgr3 = 0;
    if(((_gtv3) && (_gtv10))) _trgr3 = 1;
    _gtv39 = _trgr3;
    _gtv3 = ((_gtv3) && (_gtv10));
...
//Наименование:Задание скорости и ускорения при движении по энкодеру
    ...
    _gtv6 = ((constrain((_strFunabs1), (0), (90))))+(_swi1);
    _gtv5 = ((_gtv4)-(_gtv1)) > (0);
    _strFunabs5 = abs((_gtv4)-(_gtv1));
    if(!((_strFunabs5) < (3)))
    {
        _swi4=45;
    }
    ...
    _gtv7 = (((constrain((_strFunabs5), (0), (90))))+(_swi4))+(_gtv41);
    if ((_strFunabs5) < (3))
    {
         if (_tim3I) 
        {
             if (_isTimer(_tim3P, 40)) 
            {
                _tim3O = 1;
            }
        }
...
//Наименование:Поворот в поиске черной линии
    if (_gtv31 == 1) 
    {
        ...
        _gtv5 = _gtv33;
        _gtv12 = !(_gtv33);
        _strFunabs6 = abs(_gtv32);
        if ((((((_strFunabs6) <= (4)) && ((_strFunabs6) >= (2)))) || (_gtv34))) 
        {
            _gtv17 = 1;
        }
        if ((((((_strFunabs6) <= (4)) && ((_strFunabs6) >= (2)))) || (_gtv34))) 
    ...
    //Плата:15
//Наименование:Движение с выравниваем по оси  между двумя стенами до препятствия
//Комментарии:Простой Р-регулятор
    if (_gtv43 == 1) 
    {
        _gtv44 = (_gtv18)-(_gtv20);
        _gtv41 = (_gtv44)*(3);
        _gtv6 = (_gtv45)+(_gtv41);
        _gtv7 = (_gtv45)-(_gtv41);
        if (((_gtv21) || ((((_gtv20) < (7)) || ((_gtv20) > (35)) || ((_gtv18) < (7)) || ((_gtv18) > (35)))))) 
        {
            _gtv43 = 0;
        }
        if (((_gtv21) || ((((_gtv20) < (7)) || ((_gtv20) > (35)) || ((_gtv18) < (7)) || ((_gtv18) > (35)))))) 
...
//Наименование:Передача PWM на моторы
    ...
    if(_gtv5)
    {
        _swi2=(map((_gtv7), (0), (255), (0), (255)));
    }
    else
    {
        _swi2=(map((_gtv7), (0), (255), (0), (252)));
    }
    analogWrite(12, _swi2);
    digitalWrite(36, !(_gtv12));
    digitalWrite(37, _gtv12);
    if(_gtv12)
    {
        _swi3=(map((_gtv6), (0), (255), (0), (250)));
    }
    else
    {
        _swi3=(map((_gtv6), (0), (255), (0), (255)));
    }
    analogWrite(8, _swi3);
    //Плата:17
//Наименование:Поворот серво руки
    ...
    _strFunabs3 = abs((UB_16714688_Instance2.ubo_42736581)-(_gtv22));
    if ((_strFunabs3) <= (5)) 
    {
         if (_trgrt5I) 
        {
...
//Наименование:Поворот дальномера
    ...
    _strFunabs4 = abs((UB_16714688_Instance1.ubo_42736581)-(_gtv37));
    if ((_strFunabs4) <= (5)) 
    {
         if (_trgrt4I) 
        {
...
//Наименование:Открытие-закрытие захвата 
    _gtv26 = (_gtv24) == (2);
    if(_gtv28) _trgr6 = 0;
    if((((_gtv24) == (0)) || ((_gtv24) == (2)))) _trgr6 = 1;
    if (_trgr6)
    {
         if (_tim6I) 
        {
             if (_isTimer(_tim6P, 2850)) 
            {
                _tim6O = 1;
            }
        }
...
//Наименование:Отравка телеметрии и ответных сообщений в Bluetooth
    ...
    if (((0) && (_gtv19)))
    {
        Serial3.println((((String(_gtv20, DEC))) + (String(" ")) + ((String(_gtv15, DEC))) + (String(" ")) + ((String(_gtv18, DEC))) + (String(" ")) + ((String(_gtv2, DEC))) + (String(" ")) + ((String(_gtv1, DEC))) + (String(" ")) + ((String(_gtv32, DEC))) + (String(" ")) + (_swi6) + (String(" ")) + ((String(_gtv40, DEC)))));
    }
    if(_gtv10) _trgr2 = 0;
    if(((_gtv17) || (_gtv23) || (_gtv28) || (_gtv38))) _trgr2 = 1;
    if (_trgr2) 
    {
         if (_trgrt8I) 
        {
