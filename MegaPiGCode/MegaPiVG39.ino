...
int _convertStringToNamberOutput_18 = 0;
bool _FSFS2CO = 0;
bool _trgr1 = 0;
String _GSFS10 = "0";
...
//Наименование:Расшифровка принятого из порта
    if (_gtv10 == 1) 
    {
        ...
        _FSFS12CO = ((_gtv9).indexOf(String("V")))>-1;
        _gtv42 = _FSFS12CO;
        _GSFS11 = (_gtv9).substring((1));
        _tempVariable_String = _GSFS11;
        _convertStringToNamberOutput_18 = strtol(_tempVariable_String.c_str(),NULL,10);
        if (_FSFS12CO) 
        {
            _gtv41 = (constrain((_convertStringToNamberOutput_18), (-15), (15)));
        }
    }
    //Плата:6
...
//Комментарии:Ограничение времени поиска линии
    if(((!(_gtv3)) && (_gtv10) && (!(_gtv42)))) _trgr5 = 0;
    if(((_gtv3) && (_gtv10))) _trgr5 = 1;
    _gtv39 = _trgr5;
    _gtv3 = ((_gtv3) && (_gtv10));
...
//Наименование:Задание скорости и ускорения при движении по энкодеру
    ...
    _gtv7 = (((constrain((_strFunabs4), (0), (90))))+(_swi2))+(_gtv41);
    if ((_strFunabs4) < (3))
    {
         if (_tim2I) 
        {
...
//Наименование:Отравка телеметрии и ответных сообщений в Bluetooth
    ...
    if (((0) && (_gtv19)))
    {
        Serial3.println((((String(_gtv20, DEC))) + (String(" ")) + ((String(_gtv15, DEC))) + (String(" ")) + ((String(_gtv18, DEC))) + (String(" ")) + ((String(_gtv2, DEC))) + (String(" ")) + ((String(_gtv1, DEC))) + (String(" ")) + ((String(_gtv32, DEC))) + (String(" ")) + (_swi1) + (String(" ")) + ((String(_gtv40, DEC)))));
    }
    if(_gtv10) _trgr4 = 0;
    if(((_gtv17) || (_gtv23) || (_gtv28) || (_gtv38))) _trgr4 = 1;
    if (_trgr4) 
    {
         if (_trgrt7I) 
        {
